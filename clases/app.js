...
function mostrarHoroscopo() {
    ...
    alert(`Hola ${nombre}, aquí está tu horóscopo para este mes:\n\n${horoscopo}`);
}

// Función para dejar un mensaje en la consola
function dejarMensaje() {
    console.log("Este es un ejemplo realizado para la primera entrega en donde a con el uso de promt se ingresa meses del 1 al 12 cuando 1 es enero y 12 diciembre, lo mismo para los dias. Según la fecha ingresada se determina tu signo zodiacal.");
}
